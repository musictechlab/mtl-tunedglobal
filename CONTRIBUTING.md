# Contributing to mtl-tunedglobal
...
1. Check existing [issues](https://github.com/musictechlab/mtl-tunedglobal/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-tunedglobal/discussions)
